...
console.log(allUsers);
    ...
    document.getElementById("userName").innerText =  allUsers[allUsers.length-1].fullName;
    //----------------------------------------------------------
...
function loginUser() {
    ...
    if(fullNameVal.value.length>=3 &&
       ageVal.value <= 120 && ageVal.value >= 10) {
        ...
        document.getElementById("userName").innerText =  prevUsers[prevUsers.length-1].fullName;
    }
    else {
